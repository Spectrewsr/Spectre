...
void test_AVL( int count, int count1, int count2, vector<int> random_list, vector<int> random_list1,vector<int> list1)
{
    ...
    while ( count2-- )
    {
        avlt.root = avlt.insert( avlt.root, list1[count-count2]);   
    }

    while ( count1-- )
    {
        avlt.root = avlt.deletenode( list1[count-count1], avlt.root);
    }
    ...
    while ( count2-- )
    {
        avlt.root = avlt.insert( avlt.root, random_list[count-count2]);      
    }
    
    while ( count1-- )
    {
        avlt.root = avlt.deletenode( random_list1[count-count1], avlt.root);
    }
    end_time=clock();
...
void test_UBS( int count, int count1, int count2, vector<int> random_list, vector<int> random_list1, vector<int> list1)
{
    ...
    while ( count2-- )
    {
        ubst.root = ubst.insert( ubst.root, list1[count-count2]);   
    }
    
    while ( count1-- )
    {
        ubst.root = ubst.deletenode( ubst.root, list1[count-count1]);
    }
    ...
    while ( count2-- )
    {
        ubst.root = ubst.insert( ubst.root, random_list[count-count2]);      
    }
    
    
    while ( count1-- )
    {
        ubst.root = ubst.deletenode( ubst.root,random_list1[count-count1]);
    }
    end_time=clock();
...
void test_Spl( int count, int count1, int count2, vector<int> random_list, vector<int> random_list1, vector<int> list1)
{
    ...
    while ( count2-- )
    {
        //printf("(%d,%d) ", count2, list1[count + 1 - count2]);
        tree->Insert(list1[count - count2]);
    }
    
    while ( count1-- )
    {
        tree->Delete(list1[count-count1]);
    }

    clock_t end_time=clock();
    cout << "The splay tree run time1 is: " <<(double)(end_time - start_time) / CLOCKS_PER_SEC << "s" << endl;
    ...
    while ( count1-- )
    {
        tree->Delete(list1[count1]);
    }
    end_time=clock();
    cout << "The splay tree run time2 is: " <<(double)(end_time - start_time) / CLOCKS_PER_SEC << "s" << endl;
    ...
    while ( count2-- )
    {
        //printf("%d ",random_list[count - count2]);
        tree->Insert(random_list[count-count2]);      
    }
    
    
    while ( count1-- )
    {
        tree->Delete(random_list1[count-count1]);
    }
    end_time=clock();
    cout << "The splay tree run time3 is: " <<(double)(end_time - start_time) / CLOCKS_PER_SEC << "s" << endl;
}
int main ()
{
    int count;
