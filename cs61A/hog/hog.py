...
def swine_align(player_score, opponent_score):
    ...
    n = g(player_score, opponent_score)
    return player_score > 0 and opponent_score > 0 and n >= 10
        

def g(player_score, opponent_score):
    p, o = max(player_score, opponent_score), min(player_score, opponent_score)
    if o == 0:
        return 0
    n = p % o
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score1 < goal and score0 < goal:
        ...
        if who == 0:
            ...
            who =  not flag and other(who)
            
        elif who == 1:
            num_rolls = strategy1(score1, score0)
            score1 += take_turn(num_rolls, score0, dice)
            flag = extra_turn( score1, score0 )
            who =  flag and not other(who)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say ( score0, score1 ): 
        ...
        if who == 0:
            ...
            if increase > rht:
                rht = increase
                print(rht, 'point(s)! The most yet for Player 0')
            lst = score0
        elif who == 1:
            increase = score1 - last_score
            if increase > running_high:
                rht = increase
                print(rht, 'point(s)! The most yet for Player 1')    
            lst = score1
        return announce_highest(who, lst, rht)
...
def make_averaged(original_function, trials_count=1000):
    ...
    def average( *argv):
        ...
        while k < trials_count:
            sum , k = sum + original_function( *argv ) , k+1
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    #return 6  # Replace this statement
    # END PROBLEM 11
    s0 = free_bacon( opponent_score )
    news = score + s0
    if extra_turn( news, opponent_score) == True:
        return 0
    elif s0 >= cutoff:
        return 0
    else:
